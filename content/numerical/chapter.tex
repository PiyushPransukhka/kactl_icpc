...
\section{Fourier transforms}
  ...
  \kactlimport{GcdConv.h}
  \kactlimport{LcmConv.h}
  \kactlimport{MinPlusConv.h}
  \kactlimport{SubsetConv.h}
  %\kactlimport{NttPre.h}
  %\kactlimport{Ntt.h}
  \kactlimport{NTT.h}
  %\kactlimport{FPSinverse.h}
  %\kactlimport{FPSlog.h}
  %\kactlimport{FPSexp.h}
  %\kactlimport{FPSpow.h}
  %\kactlimport{FPSsqrt.h}
